      ...
      <div className="row align-items-center">
        <div className="col-md-6">
          ...
          <p className="custom-text">
            ...
            com presença ativa no Canadá. Apoiado por diversas marcas, possuindo grande variedade de
            produtos e atendendo mais de 3 milhões de clientes em toda a região.
          </p>
          <p className="mt-3 custom-text">
            Buscamos oferecer aos consumidores o melhor da tecnologia, diversificando o estoque
