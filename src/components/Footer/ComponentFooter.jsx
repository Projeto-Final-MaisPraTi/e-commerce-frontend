        ...
        <div className="row text-center text-md-start">
          <div className="col-md-4 col-lg-2 col-xl-2 mx-auto">
            ...
            <p>
              ...
              qualidade, como celulares, computadores, relógios digitais, câmeras e fones de ouvido.
              No nosso e-commerce, buscamos sempre atender às necessidades em constante evolução dos
              nossos clientes, inspirando-os a explorar novas possibilidades.
            </p>
          </div>
