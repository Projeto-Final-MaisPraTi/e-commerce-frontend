  ...
  render() {
    if (this.state.hasError) {
      ...
      return (
        <Container>
          <img
            src="https://media1.giphy.com/media/v1.Y2lkPTc5MGI3NjExN2VrbGx4cXhibHlnMjMwaWllNWR3YmZucXExNno1ZXQ5dHI3NW5yaiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/YTzh3zw4mj1XpjjiIb/giphy.webp"
            alt=""
          />
